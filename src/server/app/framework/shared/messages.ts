class Messages {
  ...
  public static MSG_ERROR_USER_NOT_FOUND_Mail_SEND: string = 'Email has been sent successfully on your registered email address to reset password.';//Dont Change it
  ...
  public static MSG_ERROR_INVALID_ID: string = 'Invalid User Id';
  public static MSG_ERROR_USER_NOT_PRESENT: string = 'Please enter valid login email address or password.';
  ...
  public static MSG_ERROR_NOT_USER: string = 'Provided access token is expired or is invalid';
  ...
  public static MSG_ERROR_CHECK_INACTIVE_ACCOUNT: string = "Error: Your account is still inactive. Verify your account by clicking the verification link sent to your email address."; //should be same to MSG_ERROR_ACCOUNT_STATUS
