class Constants {
  ...
  public static ALASQL_GROUP_BY_MATERIAL_TAKEOFF_MATERIAL_WISE = 'GROUP BY buildingName, costHeadName, workItemName, quantityName, unit,rate,gst ';
  ...
  public static ALASQL_SELECT_MATERIAL_TAKEOFF_MATERIAL_WISE =
    'SELECT buildingName AS header, costHeadName, workItemName AS rowValue, SUM(quantity) AS Total, unit,rate,gst ';
  ...
  public static ALASQL_SELECT_MATERIAL_TAKEOFF_COSTHEAD_WISE =
    'SELECT materialName AS header, costHeadName, workItemName AS rowValue, SUM(quantity) AS Total, unit,rate,gst';
  ...
  public static ALASQL_GROUP_MATERIAL_WORKITEM_QUANTITY_MATERIAL_TAKEOFF_COSTHEAD_WISE =
    'GROUP BY materialName, costHeadName, workItemName, quantityName, unit,rate,gst ';
  ...
  public static ALASQL_SELECT_MATERIAL_TAKEOFF_COSTHEAD_WISE_FOR_ALL_BUILDINGS =
    'SELECT materialName AS header, costHeadName, buildingName AS rowValue, SUM(quantity) AS Total, unit,rate,gst';
  public static ALASQL_GROUP_MATERIAL_BUILDING_QUANTITY_MATERIAL_TAKEOFF_COSTHEAD_WISE_FOR_ALL_BUILDINGS =
    'GROUP BY materialName, costHeadName, buildingName, quantityName, unit,rate,gst ';
