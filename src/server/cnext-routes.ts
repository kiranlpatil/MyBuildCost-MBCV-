...
export function cnextInit(app: express.Application) { //todo add interceptor to authenticate
  ...
  app.get('/api/recruiter/:id/candidatesearch/:searchvalue', recruiterController.getCandidatesByName);
  app.get('/api/candidate/:candidateId/recruiter/:recruiterId/jobprofile', searchController.searchCandidateJobProfiles);
}
