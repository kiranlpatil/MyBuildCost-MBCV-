...
export class Messages {
  ...
  public static MSG_ERROR_VALIDATION_MAX_CAPABILITIES_CROSSED = "You can select maximum 10 capabilities. To select a new capability, deselect any of the earlier ones.";
